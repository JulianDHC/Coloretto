...
private:
    ...
    string obtenerColor(int numero) {
        switch (numero) {
            case 0: return "\033[38;5;214mNaranjado\033[0m"; // Naranjado (Amarillo)
            case 1: return "\033[34mAzul\033[0m"; // Azul
            case 2: return "\033[33mCafe\033[0m"; // Café (Amarillo)
            case 3: return "\033[35mMorado\033[0m"; // Morado
            case 4: return "\033[32mVerde\033[0m"; // Verde
            case 5: return "\033[31mRojo\033[0m"; // Rojo
            case 6: return "\033[33mAmarillo\033[0m"; // Amarillo
            case 7: return "\033[36mSumar 2\033[0m"; // Cyan (Sumar 2)
            case 8: return "\033[36mComodín\033[0m"; // Cyan (Comodín)
            case 9: return "\033[33mComodín dorado\033[0m"; // Dorado (Amarillo)
            default: return "\033[31mError carta inexistente\033[0m"; // Rojo (Error)
        }
    }
